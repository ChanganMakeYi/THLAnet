...
df["Epitope"] = df["Epitope"].astype(str).fillna("")
sequences = df["Epitope"].tolist()
...
trainer.save_model("./epitope_650_pretraining/final_model")
tokenizer.save_pretrained("./epitope_650_pretraining/final_model")